...
export const DetailsAuction = () => {
  ...
  return (
    <SafeAreaView>
      ...
      <ScrollView>
        <View style={styles(theme).auction}>
          <Image
          ...
          <View style={styles(theme).placeBidView}>
            <Text style={styles(theme).placeBidTitle}>Reserve Price</Text>
            <View style={styles(theme).placeBidPriceView}>
              <Text style={styles(theme).placeBidPriceLarge}>1.50 ETH</Text>
              <Text style={styles(theme).placeBidPriceSmall}>$2,683.73</Text>
            </View>
            <Text style={styles(theme).placeBidParagraph}>
